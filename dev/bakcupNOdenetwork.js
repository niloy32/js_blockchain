...
app.post("/transaction", function (req, res) {
    // const blockIndex = bitcoin.createNewTransaction(req.body.amount, req.body.sender, req.body.recipient, req.body.data)
    // res.json({
    //     note: `Transaction will be addded in block ${blockIndex}.`
    // });
    const newTransaction = req.body;
    const blockIndex = bitcoin.addTransactionToPendingTransaction(
        newTransaction
    );
    res.json({
...
app.post("/transaction/broadcast", function (req, res) {
    ...
    Promise.all(requestPrmomies).then((data) => {
        res.json({
...
//             blockchains.forEach(xchain => {
//                 console.log("xchain data: "+JSON.stringify(xchain));
//             })
//             // blockchains.forEach(test_chain => {
//             //     console.log("look : " + test_chain.chain.length)
//             //     if (test_chain.chain.length > maxChainlength) {
//             //         maxChainlength = test_chain.chain.length;
//             //         newLongestChain = test_chain.chain
//             //         newPendingTransactions = test_chain.PendingTransactions;
//             //     }
//             // });
//             if (
//                 !newLongestChain ||
...
//             ) {
//                 res.json({
//                     note: "current chain is not been replace",
//                     chain: bitcoin.chain
//                 });
